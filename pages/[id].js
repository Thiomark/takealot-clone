      ...
      <div className="bg-gray-100 ">
        <div className="sides lg:grid-rows-[auto_1em_auto_auto_auto_auto_auto_auto] xl:grid-cols-[1fr_1fr_20px_minmax(300px,_auto)] pb-20 space-y-2 grid lg:grid-cols-2">
          <ProductHeaderComponent
            style={"w-full hidden col-start-1 xl:col-end-5 col-end-3 lg:block"}
            links={links}
          />
          <div className="bg-white lg:-mx-4 xl:mx-0 hidden xl:row-start-2 lg:block xl:col-end-3 col-span-2 col-start-1 col-end-3 row-start-2 row-end-6">
            &nbsp;
          </div>
          ...
          <ProductPriceComponent
            style={
              "p-4 lg:pb-0 xl:pb-4 bg-white xl:col-start-4 xl:col-end-5 xl:row-start-2 shadow lg:col-start-2 lg:col-end-3 lg:shadow-none lg:row-start-3 lg:row-end-4"
            }
          />
          <ProductSummaryComponent
            style={
              "p-4 lg:pt-0 xl:pt-4 bg-white shadow lg:col-start-2 xl:row-start-2 lg:col-end-3 lg:shadow-none lg:row-start-4 lg:row-end-5"
            }
          />
          ...
          <ProductDescriptionComponent
            style={
              "sides-scale bg-white w-full xl:col-start-1 xl:col-end-3 lg:col-span-2 overflow-none shadow relative"
            }
          />
          <div className="bg-white lg:col-span-2 xl:col-start-1 xl:col-end-3">
            <h1 className="py-4 sides-scale-x font-bold text-gray-500">
              Product Information
            </h1>
            <table className="w-full text-sm">
              <tbody>
                {Object.keys(product.productInfo).map((item, index) => (
                  <tr key={index}>
                    <th className="text-left font-semibold text-gray-500 border py-2 sides-scale-x">
                      {item}
                    </th>
                    <td className="text-left font-light text-gray-400 border py-2 sides-scale-x">
          ...
          <ReviewsComponent
            style={
              "sides-scale gap-10 bg-white xl:col-start-1 xl:col-end-3 shadow lg:col-span-2"
            }
          />
