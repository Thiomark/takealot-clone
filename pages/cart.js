...
const Cart = () => {
    ...
    return (
        <Layout title='Cart - TAKEALOT'>
            <h1 className='text-xl py-4 w-full mx-4 md:sides font-bold text-gray-600'>Shopping Cart</h1>
            {cart.length > 0 && <div className='pb-10'>
                <div className='lg:flex md:sides w-full'>
                    <div className='w-full space-y-2'>
                        {cart.map(item => 
                        <div key={item.id} className='bg-white pt-8 relative grid-cols-[1em_6em_1fr_1fr_6em_1em] grid-rows-[auto_auto_auto_2em_auto] md:grid-rows-[auto_auto_auto_2em_auto_1.5em] grid items-stretch'>
                            ...
                            <h1 className='col-start-3 ml-4 font-semibold text-lg col-end-6 md:col-end-5 md:row-start-1'>{item.name}</h1>
                            <h1 className='col-start-3 md:col-start-5 md:row-start-1 ml-4 col-end-6 font-bold text-lg'>R {item.price}</h1> 
                            ...
                            <button onClick={() => deleteFromCart(item.id)} className='text-gray-700 md:text-xs md:row-start-4 md:col-start-5 md:static absolute top-4 right-4 flex items-center space-x-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi md:w-5 md:h-5 w-6 h-6 bi-trash-fill" viewBox="0 0 16 16">
                            ...
                            <button onClick={() => {
                                ...
                                addItemToList(item.id)}} className='text-gray-700 md:text-xs md:mr-6 md:col-end-5 md:ml-auto text justify-center flex items-center space-x-2 col-start-4 col-end-7 row-start-5 border md:border-none md:row-start-4 md:col-start-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi md:block hidden md:w-5 md:h-5 w-6 h-6 bi-trash-fill" viewBox="0 0 16 16">
                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                </svg>
                                <span className=''>Move To List</span>
                            </button>
                        </div>)}
                        <p className='py-6 mx-4 md:mx-0 text-center md:text-left text-sm text-gray-700'>Placing an item in your shopping cart does not reserve that item or price. We only reserve stock for your order once payment is received.</p>
                    </div>
                    <div className='hidden lg:block space-y-3 sides-scale-x max-w-[300px] w-full'>
                        ...
                        <div className='p-4 text-sm text-gray-700 space-y-2 bg-white'>
                            <div className='flex items-center space-x-3'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi h-5 w-5 bi-lock-fill" viewBox="0 0 16 16">
            ...
            {cart.length === 0 && <div className='sides w-full pb-10'>
