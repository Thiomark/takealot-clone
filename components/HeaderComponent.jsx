                ...
                <div className={`${isMenuOpen ? 'translate-x-0 shadow-[0_0_0_100vw_rgba(0,0,0,0.7)]' : '-translate-x-full shadow-[0_0_0_100vw_rgba(0,0,0,0)] scale-100'} w-3/5 h-full flex flex-col bg-gray-100 transition duration-500 relative after:content-["x"] after:hover:cursor-pointer after:absolute after:-right-6 after:text-white after:text-2xl`}>
                    <div>
                        ...
                        <div className='bg-white shadow mt-4 text-sm divide-y-[1px] divide-gray-100'>
                            {headerPagesLinks.map((item, index) => <button onClick={(e) => {
                                e.stopPropagation();
                        ...
                        <div className='bg-white shadow mt-4 text-sm divide-y-[1px] divide-gray-100'>
                            {bottomLinks.map((item, index) => 
                                <button onClick={(e) => {
                                    ...
                                    router.push(item.url);
                                    setIsMenuOpen(false);
                                }} className='w-full p-4 justify-between flex items-center' key={index}>
            ...
            <div className='sides flex py-4 items-center justify-between'>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <div className='md:flex text-sm items-center hidden'>
                        <Link href="/help" className='hover:underline hover:text-blue-450'>Help</Link>
                        <div className={divider()  + ' hidden md:hidden lg:inline-block'} />
                        <Link href='#' className='hidden lg:inline hover:underline hover:text-blue-450'>Sell on Takealot</Link>
                    </div>
                </div>
                <div className='flex items-center space-x-4'>
                    <div className='md:flex hidden text-sm items-center'>
                        <Link href="/account/login" className='hover:underline hover:text-blue-450'>Login</Link>
                        <div className={divider()} />
                        <Link href="/account/register" className='hover:underline hover:text-blue-450'>Register</Link>
                        <div className={divider()} />
                        <Link href='#' className='hidden lg:inline hover:underline hover:text-blue-450'>Orders</Link>
                        <div className={divider() + ' hidden md:hidden lg:inline-block'} />
                        <Link href="/account" className='hover:underline hover:text-blue-450'>My Account</Link>
                    </div>
