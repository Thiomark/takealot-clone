                ...
                <div className='sides flex py-4 items-center justify-between'>
                    ...
                    <div className='flex items-center space-x-4'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <SVGButtonComponent event={() => router.push('/cart')} after={cart.length} spanStyle='ml-1 hidden text-white text-xs md:inline' iconStyle='h-5 w-5 text-gray-750 md:text-white' btnStyle="h-9 w-9 md:w-auto md:px-4 rounded-full p-2 flex items-center justify-center md:bg-green-450">
