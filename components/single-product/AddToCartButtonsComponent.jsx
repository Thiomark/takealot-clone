...
const AddToCartButtonsComponent = ({ extraStyle }) => {
  ...
  const { addItemToCart, addItemToList, loading: cartLoading } = useCart();
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex text-sm font-bold items-center justify-center space-x-2 text-black bg-gray-300 w-full p-3"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          className="bi h-5 w-5 bi-heart"
          viewBox="0 0 16 16"
        >
